...
public class PrettyTimeUtils {
    ...
    /** 
     * @Title: prettySeconds 
     * @Description: TODO:显示秒值为**年**月**天 **时**分**秒  如1年2个月3天 10小时
     * @param @param totalSeconds
     * @param @return    设定文件 
     * @return String    返回类型 
     * @throws 
     */
    ...
    /** 
     * @Title: prettyTime 
     * @Description: TODO:美化时间 如显示为 1小时前 2分钟前
     * @param @param date
     * @param @return    设定文件 
     * @return String    返回类型 
     * @throws 
