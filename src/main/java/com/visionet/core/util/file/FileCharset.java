...
/** 
 * @ClassName: FileCharset 
 * @Description: TODO: 判断文件编码,只能判断常见的GBK，UTF-16LE，UTF-16BE,UTF-8，其分别对应window下的记事本可另存为的编码类型ANSI,Unicode,Unicode big endian,UTF-8
 * @date 2015年3月18日 下午1:53:12 
 *  
 */
